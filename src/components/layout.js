                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <ActiveLink activeClassName="bg-indigo-900" href="/">
                                        <a
                                            className="px-3 py-2 rounded-md text-sm font-medium text-white focus:outline-none focus:text-white focus:bg-indigo-700">Dashboard</a>
                                    </ActiveLink>
                                </div>
                            </div>
                        </div>
